...
// ===----------------------------------------------------------------------===//
//
// This source file is part of the swift-collection-primitives open source project
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-collection-primitives project authors
...
// Shape-γ unified consumer manifest. swift-collection-primitives does NOT
